...
* [FEATURE] add support for tags per instance. See [#411](https://github.com/DataDog/integrations-core/pull/411). Thanks [@frederikhappel](https://github.com/frederikhappel).
