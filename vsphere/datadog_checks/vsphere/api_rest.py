...
class VSphereRestClient(object):
    ...
    API_ENDPOINTS = {
        'current': {
            ...
            'tags-get': 'cis/tagging/tag/id:{}',
            'category-get': 'tagging/category/{}',
            'session': 'session',
        },
        'deprecated': {
    ...
    def session_create(self):
        ...
        """
        session_token = self._request_json(self.endpoints['session'], method="post", extra_headers=self.JSON_REQUEST_HEADERS)
