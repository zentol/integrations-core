...
| `assets[dashboards]`                                 | Object                   | Optional                    | Out-of-the-box dashboards associated with this offering.                                                                                                                                                                              |  |
...
| `assets[integration]`                                | Object                   | Optional                    | Object containing information about the integration.                                                                                                                                                                                  |  |
...
| `assets[monitors]`                                   | Object                   | Optional                    | Recommended monitors.                                                                                                                                                                                                                 |  |
...
| `legal_terms `                                       | Object                   | Mandatory                   | Any legal documentation that a user needs to agree to in order to use this app.                                                                                                                                                       |  |
| `legal_terms[eula] `                                 | String                   | Mandatory                   | Relative path to the EULA (End User License Agreement) PDF in relation to this manifest.                                                                                                                                              |  |
| `pricing`                                            | Array of Object          | Mandatory                   | List of objects representing the pricing model of the integration. See [Marketplace GitHub repository][1] for pricing details. The Marketplace GitHub repository is private, email marketplace@datadog.com for access.                |  |
| `tile[media]`                                        | Array of Object          | Mandatory, can be `[ ]`     | Information about various image and video style objects that are presented in the media gallery carousel on the listing page.                                                                                                         |  |
