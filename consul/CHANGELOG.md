...
* [Added] Add a check to count all nodes in a consul cluster. See [#1479](https://github.com/DataDog/integrations-core/pull/1479). Thanks [TylerLubeck][9](https://github.com/TylerLubeck).
