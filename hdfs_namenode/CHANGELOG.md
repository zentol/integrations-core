...
* [BUGFIX] Fix regression where instance tags were required. See [#1132](https://github.com/DataDog/integrations-core/issues/1132)

## 1.2.0 / 2018-02-13

* [FEATURE] add instance level tags to metrics and service check. See [#1047](https://github.com/DataDog/integrations-core/issues/1047)

## 1.1.0 / 2018-01-10

* [FEATURE] adds configuration option to ignore SSL validation. See [#714](https://github.com/DataDog/integrations-core/issues/714)
