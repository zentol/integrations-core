...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'ibm_ace', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-ibm_ace',
    version=ABOUT['__version__'],
    description='The IBM ACE check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent ibm_ace check',
    ...
    packages=['datadog_checks.ibm_ace'],
